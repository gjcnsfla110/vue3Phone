<script setup>
import {checkAgreementList} from "@/api/phone/phoneList.js";
import {menuListTrees, orderTrees, priceDollar} from "@/composables/useCommon.js";
...
//상품 리스트갖고오는 함수
const getData = ()=>{
  checkAgreementList(currentPage.value,limit.value,{sideCategory_id:searchCategoryId.value}).then((res)=>{
    ...
    <el-container>
      ...
      <el-main>
        ...
        >
          ...
          <el-table-column label="타이틀" width="300" prop="title" align="center"></el-table-column>
          <el-table-column label="통신사" width="200" align="center">
             <template #default="{row}">
               <el-button   type="primary" v-if="row.mobile ===1">LG通信社</el-button>
               <el-button   type="primary" v-else-if="row.mobile ===2">KT通信社</el-button>
               <el-button   type="primary" v-else-if="row.mobile ===3">SK通信社</el-button>
               <el-button   type="primary" v-else-if="row.mobile ===4">LG网线</el-button>
               <el-button   type="primary" v-else-if="row.mobile ===5">KT网线</el-button>
               <el-button   type="primary" v-else-if="row.mobile ===6">SK网线</el-button>
               <el-button   type="primary" v-else-if="row.mobile ===7">알뜰LG网线</el-button>
               <el-button   type="primary" v-else-if="row.mobile ===8">알뜰KT网线</el-button>
               <el-button   type="primary" v-else-if="row.mobile ===9">알뜰SK网线</el-button>
             </template>
          </el-table-column>
          <el-table-column label="가격" width="180" align="center">
            <template #default="{row}">
          ...
          <el-table-column label="색상" prop="store" align="center" width="180">
          </el-table-column>
          <el-table-column label="상품설명" width="180" align="center">
            <template #default="{row}">
