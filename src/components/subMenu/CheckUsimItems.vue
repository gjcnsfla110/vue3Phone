<script setup>
import {checkUsimList} from "@/api/usim/usimList.js";
import {ref} from "vue";
import {listTrees, orderTrees, priceDollar} from "@/composables/useCommon.js";
...
//상품 리스트갖고오는 함수
const getData = ()=>{
  checkUsimList(currentPage.value,limit.value,{sideCategory_id:searchCategoryId.value}).then((res)=>{
    dataList.value=res.list;
    total.value = res.total;
    menulist.value = listTrees(res.usimCategorys);
    ...
    <el-container>
      ...
      <el-main>
        ...
        >
          ...
          <el-table-column label="타이틀" width="350" prop="title"></el-table-column>
          <el-table-column label="통신사" align="center" width="180" prop="mobile_name">
          </el-table-column>
          <el-table-column label="인터넷망" align="center" width="180" prop="mobile_type">
          </el-table-column>
          <el-table-column label="월요금" width="280" align="center">
