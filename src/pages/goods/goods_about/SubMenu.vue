...
import {createSubMenu,getSubMenuList,updateSubMenu,deleteSubMenu,updateStatus} from "@/api/goods/subMenu.js";
...
const {
      ...
      afterDataList:(res)=>{
        menus.value = listTrees(res.menus,'category_id','child');
        dataList.value = res.list;
        total.value = res.total;
      },
      getList: getSubMenuList,
